...
def normalize_pykrx_date(value: str | date | datetime) -> str:
...
def fetch_benchmark_price(
    ...
    *,
    ...
    raw_df = stock.get_index_ohlcv_by_date(
        normalize_pykrx_date(start_date),
        normalize_pykrx_date(end_date),
        index_code,
    )
...
def create_benchmark_price_dataframe(
    ...
    *,
    ...
    raise ValueError("source must be 'pykrx' or 'bronze'")
