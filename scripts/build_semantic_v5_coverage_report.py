...
GOLDEN_CORPUS = ROOT / "data-lake" / "meta" / "rules" / "semantic_golden_contract_v5.jsonl"
GOLDEN_EVAL = ROOT / "deliverables" / "semantic_golden_contract_v5_evaluation.json"
OPERATIONAL = ROOT / "deliverables" / "semantic_rule_engine_v5_operational_coverage.json"
HISTORICAL = ROOT / "deliverables" / "historical_semantic_audit_2000_2012_v5.json"
COMPANY_YEAR = ROOT / "deliverables" / "company_year_financial_completeness_v5.json"
...
OUTPUT = ROOT / "deliverables" / "semantic_rule_engine_v5_coverage.json"
...
def build_report() -> dict[str, Any]:
    ...
    report = {
        ...
        "factor_cell_coverage": {
            ...
            "comparison_note": "The v5 primary result uses disclosure dates and no financial period-end fallback; it is stricter than the v4 baseline. A decrease is an accuracy correction, not a regression.",
        },
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build semantic rule engine v5 evidence report.")
        ...
        json.dumps(
            {
                ...
                "factor_cell_coverage_pct": report["factor_cell_coverage"]["v5_pit_safe"]["coverage_pct"],
